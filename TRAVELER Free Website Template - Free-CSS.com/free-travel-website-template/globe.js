...
var globe = planetaryjs.planet();
    ...
    globe.loadPlugin(planetaryjs.plugins.earth({
      ...
      oceans:   { fill:   '#20639B' },
      land:     { fill:   '#ffffff' },
      borders:  { stroke: '#cccccc' } //#f7931e 08a0cc
    }));
    ...
    setInterval(function() {
      ...
      { 
        ...
        globe.plugins.pings.add(-pingsloc[0], -pingsloc[1], { color: color, ttl: 2000, angle: 4 });
      }
      else
      {
        var c=Math.floor(Math.random() * lat.length);
        globe.plugins.pings.add(lng[c], lat[c], { color: color, ttl: 2000, angle: 4 });
    ...
    function goto_australia2() {
      globe.plugins.autorotate.speedchange(100);
    };
